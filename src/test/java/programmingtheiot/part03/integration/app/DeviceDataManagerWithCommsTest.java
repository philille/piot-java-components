...
//	@Test
	...
	public void testSendActuationEventsToCda()
	{
	    ...
	    float nominalVal = cfgUtil.getFloat(ConfigConst.GATEWAY_DEVICE,   ConfigConst.NOMINAL_HUMIDITY_SETTING);
	    float lowVal     = cfgUtil.getFloat(ConfigConst.GATEWAY_DEVICE,   ConfigConst.TRIGGER_HUMIDIFIER_FLOOR);
	    float highVal    = cfgUtil.getFloat(ConfigConst.GATEWAY_DEVICE,   ConfigConst.TRIGGER_HUMIDIFIER_CEILING);
	    int   delay      = cfgUtil.getInteger(ConfigConst.GATEWAY_DEVICE, ConfigConst.HUMIDITY_MAX_TIME_PAST_THRESHOLD);
