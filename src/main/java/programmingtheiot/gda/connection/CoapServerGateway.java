...
//    }
	...
	public boolean stopServer()
	{
	    try {
	        if (this.coapServer != null) {
	            ...
	            _Logger.warning("CoAP server STOP failed.Not yet initial.");
	        }
	    }catch (Exception e) {
	...
	// you can call from one of your constructors 
	//to explicitly implement resource handler instancing and registration
	...
	//make server knows there is a hierarchy of the resource
