...
public class CoapServerGateway
{
	...
	//Method named setDataMessageListener to handle callbacks into the DeviceDataManager class (which implements IDataMessageListener. 
...
//		UpdateSystemPerHandler updateTelemetryResourceHandler =
